#-*- coding: utf-8 -*-
# Copyright 2020 LeBert Sam Billgates
#SciX has been licensed under GNU General Public License v3
#All the icons are works of multiple authors in flaticon
...
class Ui(QtWidgets.QMainWindow,QWidget):
    ...
    def treeitemdoubleClicked(self, index):
        ...
        if self.adobecheck==False:
            ...
            if self.filedup != file:
                self.filedup = file
                os.startfile(self.savetofolderpath + '/' + file)
            else:
                pass
    def setadobe(self):
        sys.excepthook = self.show_exception_and_exit
